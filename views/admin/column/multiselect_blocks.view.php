...
if ($item->blco_context) {
    $where_options['block_context'] = $item->blco_context;
}
$options = \Arr::assoc_to_keyval(\Novius\Blocks\Model_Block::find('all', array('where' => $where_options)), 'block_id', 'block_title');
