                    ...
                    foreach (\Arr::get($column, 'blocks') as $block) {
                        ...
                        <div class="block column" style="width: <?= \Novius\Blocks\Display::decimalToPoint($block_width * (100 / $col_width)) ?>%;">
                            <?php if ($display->blod_mode == 'fixed') {
                                ...
                                ?>
                                <div class="grid-block-square" style="height: 0; padding-bottom: <?= \Novius\Blocks\Display::decimalToPoint($height_ratio) ?>%; width: 100%; position: relative; overflow: hidden;">
                                    <div class="grid-block-square-layout" style="width: 100%; height: 100%; position: absolute; left: 0;">
